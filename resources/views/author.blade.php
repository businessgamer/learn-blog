                    ...
                    <div class="instructor-sidebar-sticky">
                        ...
                        <div class="content">
                            ...
                            <div class="instructor-social">
                                <h4>Follow Me On:</h4>
                                <ul>
                                    <li><a href="{{ $author->fb_link }}" target="_blank"><img src="{{config('app.url')}}/assets/img/icon/fb.svg" alt="icon"></a></li>
                                    <li><a href="{{ $author->in_link }}" target="_blank"><img src="{{config('app.url')}}/assets/img/icon/ins.svg" alt="icon"></a></li>
                                    <li><a href="{{ $author->tw_link }}" target="_blank"><img src="{{config('app.url')}}/assets/img/icon/tw.svg" alt="icon"></a></li>
                                    <li><a href="{{ $author->pn_link }}" target="_blank"><img src="{{config('app.url')}}/assets/img/icon/pn.svg" alt="icon"></a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
