            ...
            <div class="row align-items-center">
                <div class="col-lg-4 col-md-12 col-sm-12">
                    <div class="subcribe-content">
                        <img src="{{ config('app.url') }}/assets/img/svg/google-search-engine.png" alt="google-search-engine">
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-lg-4 col-sm-6 col-md-6">
                    <div class="edu-services-box">
                        ...
                        <p>Our expert teachers are always ready to help you. If any question comes to your mind while reading, you can telegram us. Our expert teachers will answer your questions within 24 hours.</p>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-lg-6 col-md-6 col-sm-12">
                    <div class="single-artical-box ">
                        ...
                        <div class="content">
                            ...
                            <ul class="cr-items">
                                <li><a href="#"><i class='bx bx-calendar'></i><span>25 Feb, 23</span></a></li>
                                <li><a href="#"><i class='bx bx-user'></i><span>2k Students</span></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6 col-sm-12">
                    <div class="single-artical-box ">
                        ...
                        <div class="content">
                            ...
                            <h3><a href="blog-single">Creative Writing Through Storytelling</a></h3>
                            <ul class="cr-items">
                                <li><a href="#"><i class='bx bx-calendar'></i><span>29 Feb, 23</span></a></li>
                                <li><a href="#"><i class='bx bx-user'></i><span>4k Students</span></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6 col-sm-12">
                    <div class="single-artical-box ">
                        ...
                        <div class="content">
                            ...
                            <h3><a href="blog-single">Product Manager Learn The Skills & Job</a></h3>
                            <ul class="cr-items">
                                <li><a href="#"><i class='bx bx-calendar'></i><span>02 Feb, 23</span></a></li>
                                <li><a href="#"><i class='bx bx-user'></i><span>1k Students</span></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6 col-sm-12">
                    <div class="single-artical-box ">
                        ...
                        <div class="content">
                            ...
                            <h3><a href="blog-single">The Power of Podcast for Storytelling</a></h3>
                            <ul class="cr-items">
                                <li><a href="#"><i class='bx bx-calendar'></i><span>21 Feb, 23</span></a></li>
                                <li><a href="#"><i class='bx bx-user'></i><span>5k Students</span></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
