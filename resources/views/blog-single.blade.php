                    ...
                    <div class="blog-details-desc">
                        ...
                        <div class="article-content">
                            <div class="entry-meta">
                                <ul>
                                    @isset($blog->user)
                                        <li><i class='bx bx-user'></i> <a href="#">{{$blog->user->name}}</a></li>
                                    @endif
                            ...
                            <div class="article-footer">
                                ...
                                <div class="article-share">
                                    <span>Share On:</span>
                                    <ul class="social">
                                        <li><a href="#" class="facebook" target="_blank"><img src="{{ config('app.url') }}/assets/img/icon/fb.svg" alt="icon"></a></li>
                                        <li><a href="#" class="twitter" target="_blank"><img src="{{ config('app.url') }}/assets/img/icon/ins.svg" alt="icon"></a></li>
                                        <li><a href="#" class="linkedin" target="_blank"><img src="{{ config('app.url') }}/assets/img/icon/tw.svg" alt="icon"></a></li>
                                        <li><a href="#" class="linkedin" target="_blank"><img src="{{ config('app.url') }}/assets/img/icon/pn.svg" alt="icon"></a></li>
                                    </ul>
                                </div>
                            </div>
                                        ...
                                        <div class="info-prev-link-wrapper">
                                            <a href="{{ route('blog.slug',$prevPost->slug) }}">
                                                <span class="image-prev">
                                                    <img src="{{Voyager::image($prevPost->image)}}" alt="{{$prevPost->title}}">
                                                </span>
                                    ...
                                    <div class="next-link-wrapper">
                                        <div class="info-next-link-wrapper">
                                            ...
                                            <span class="prev-link-info-wrapper">
                                                ...
                                                <span class="image-prev">
                                                 <img src="{{Voyager::image($nextPost->image)}}" alt="{{$nextPost->title}}">
                                            </span>
                                            </a>
                                        </div>
                                    </div>
                                ...
                                @foreach($recentBlogs as $recent_blog)
                                    <article class="item">
                                        <a href="{{ route('blog.slug',$recent_blog->slug) }}" class="thumb">
                                            <img src="{{Voyager::image($recent_blog->image)}}" alt="{{$recent_blog->title}}">
                                        </a>
                                        <div class="info">
                                            <h4 class="title">
                                                <a href="{{ route('blog.slug',$recent_blog->slug) }}">{{$recent_blog->title}}</a>
                                            </h4>
                                            <a href="{{ route('blog.slug',$recent_blog->slug) }}" class="re-blog-btn">Read More</a>
                                        </div>
                                    </article>
                                @endforeach
                            </div>
